 ...
 */
final class Version20250107230751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, title VARCHAR(255) NOT NULL, localisation VARCHAR(255) NOT NULL, technologie VARCHAR(255) DEFAULT NULL, experience_level INT NOT NULL, salary DOUBLE PRECISION DEFAULT NULL, detail LONGTEXT NOT NULL, INDEX IDX_5A8A6C8DA4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
