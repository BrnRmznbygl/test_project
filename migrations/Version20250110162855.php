 ...
 */
final class Version20250110162855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE developper (id INT AUTO_INCREMENT NOT NULL, user_developper_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, localisation VARCHAR(255) DEFAULT NULL, views INT NOT NULL, created_at DATETIME NOT NULL, languages JSON DEFAULT NULL, experience_level INT NOT NULL, min_salary DOUBLE PRECISION DEFAULT NULL, bio LONGTEXT DEFAULT NULL, avatar_url VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_63D89B41E32A86C3 (user_developper_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
